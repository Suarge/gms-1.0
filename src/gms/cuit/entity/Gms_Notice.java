...
public class Gms_Notice implements Serializable{
	...
	public String toString() {
		return "Gms_Notice [notice_Id=" + notice_Id + ", notice_Time=" + notice_Time + ", notice_Man=" + notice_Man
				+ ", notice_Content=" + notice_Content + ", notice_Title=" + notice_Title + ", notice_State="
				+ notice_State + "]";
	}

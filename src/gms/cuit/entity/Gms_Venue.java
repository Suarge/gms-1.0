...
public class Gms_Venue implements Serializable{
	...
	public Gms_Venue(String venue_Id, String venue_Type, String venue_Name, Double venue_Price, Integer venue_Capacity,
			Integer venue_Open, Integer venue_Close, Integer venue_IsDel) {
		super();
	...
	public String toString() {
		return "Gms_Venue [venue_Id=" + venue_Id + ", venue_Type=" + venue_Type + ", venue_Name=" + venue_Name
				+ ", venue_Price=" + venue_Price + ", venue_Capacity=" + venue_Capacity + ", venue_Open=" + venue_Open
				+ ", venue_Close=" + venue_Close + ", venue_IsDel=" + venue_IsDel + "]";
	}
